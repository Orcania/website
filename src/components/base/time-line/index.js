...
//                 <h1 className="title is-5 has-text-primary has-text-centered mb-5">Grab & drag </h1>
//             </div>
...
//                             <div
//                                 className="box odd has-background-dark2primary-v is-flex is-flex-direction-column"
//                                 style={{ height: '350px' }}
//                             >
...
//                                     <p className="has-text-white h is-size-6 has-text-distriute">{item.body}</p>
//                                 </div>
//                             </div>
//                         </div>
//                     ))}
...
//                             <div
//                                 className="box even has-background-dark2primary-v is-flex is-flex-direction-column"
//                                 style={{ height: '350px' }}
//                             >
//                                 <h1 className=" title has-text-white has-text-left is-4">{item.title}</h1>
//                                 <h1 className="subtitle has-text-contrast has-text-left is-6">{item.subtitle}</h1>
//                                 <div className="is-flex-grow-1 has-cool-scroll pr-3" style={{ overflowY: 'auto' }}>
//                                     <p className="has-text-white is-size-6 has-text-distriute">{item.body}</p>
//                                 </div>
//                             </div>
//                         </div>
//                     ))}
