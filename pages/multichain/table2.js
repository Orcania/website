                ...
                <table className="table has-background-traansparent has-text-dark is-size-5">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <h1 className="subtitle is-4"> Other Bridges </h1>
                            </th>
                            <th>
                                <h1 className="subtitle is-4 has-text-contrast"> Orcania Bridge </h1>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td className="has-text-contrast has-background-semi">
                                Support to all tokens and assets, the Orcania bridge allows anyone to add any token they
                                want to the bridge
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>none</td>
                            <td className="has-text-contrast has-background-semi">
                                First bridge to openly support all NFT standards
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="has-text-contrast has-background-semi">
                                Transaction fee of less than a cent
                            </td>
                        </tr>
                        <tr>
