export const tokenomicsData = [
    ...
    //       the nodes sale. <br />
    //       <br />
    //       Funds raised from the nodes sale will be locked as liquidity on the
    //       Orcania-DEX. This allocation is to provide the OCA part of the
    //       liquidity. <br />
    //       <br />
    //       Any OCA left from this allocation and from the nodes sale will either be
    ...
    //       <br />
    //       This sale will allow nodes to aquire OCA at a fixed price without any
    //       fluctuations. The price will be decided based on the price of OCA on the
    //       Orcania-DEX
    //       <br />
    //       <br />
    //       The nodes sale is intended to help validator node operators secure the
    //       bridge, and as such certain terms are set to make sure OCA purchased
    //       from the nodes sale is used for its intended purpose. <br />
    //       <br />
    //       Users that aquire OCA from the nodes sale but does not use it to run a
    //       validator node or delegate to one, will have a lock period of 2 years on
    //       their OCA. <br />
    //       Nodes that aquire OCA from the nodes sale but does not put it all into
    //       running a validator node and securing the bridge, will have a lock
    //       period of 2 years on their OCA. <br />
    //       Nodes that aquire OCA from the nodes sale and put it all into running a
    //       node and securing the bridge will have a lock period of only 1 year on
    ...
    //   <br />
    //   <br />
    //   This allocation will be used to supply OCA liquidity to the DEX, while
    //   the Orcania team and our partners provide other tokens to be provided as
    //   liquidity to the DEX. <br />
    //   <br />
    //   After the mainnet release of the Orcania Bridge, this allocation will be
    //   used to contribute to the growth of the ecosystem through grants,
    //   bounties and hackathons to encourage and support developers on expanding
    //   their ideas beyond one blockchain and building multichain apps.
    //   <br />
    //   <br />
    //   10% of the OCA release supply will be allocated to help fund such
    //   projects and push them forward on their journey, live development
    //   support from our team to teams building on these projects will be
    //   available to help them better grasp the architecture of the DEX and the
